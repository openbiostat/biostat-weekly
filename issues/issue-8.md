...
![科学家训练 AI 来解决数学难题](https://cdn.jsdelivr.net/gh/Leslie-Lu/images/images/20251113203446.png)
...
辅助化疗使胰腺导管腺癌（PDAC）患者受益，但术后患者的身体状态可能会阻碍依从性。需要生物标志物来确定及时辅助治疗的候选者。在本项前瞻性观察性研究中，研究者纳入了1171例接受胰腺切除术的PDAC患者，并进行了广泛的随访。对191例患者样本的蛋白质组学分析揭示了临床相关的功能蛋白模块，并为PDAC建立了一个基于蛋白质组学水平的预后风险模型，并使用公开的外部队列进一步验证了其准确性。更重要的是，通过利用临床和蛋白质组数据集的交互效应回归分析，发现了两个生物标志物（NDUFB8和CEMIP2），表明了PDAC患者对辅助化疗的总体敏感性。并且文章将文献分析所用代码整理成了一本书，每一个文献中的fig都可以进行学习和复现。
...
3. [11月10日起，满13周岁女孩免费接种HPV疫苗](https://mp.weixin.qq.com/s/pnwqM1qpiX_zfa42nJ8aPw)

![](https://cdn.jsdelivr.net/gh/Leslie-Lu/images/images/20251113205802.png)

国家疾控局等七部门发出通知，经国务院同意，将人乳头瘤病毒疫苗也就是HPV疫苗纳入国家免疫规划，自2025年11月10日起，组织各地为2011年11月10日以后出生的满13周岁女孩免费接种2剂次双价HPV疫苗（间隔6个月）。此前已自费接种首针疫苗的适龄女孩，也可免费接种第二针。

4. [地中海饮食与江南饮食](https://mp.weixin.qq.com/s/IEwhH6w_NVr8TuLmRCZwtg)

![](https://cdn.jsdelivr.net/gh/Leslie-Lu/images/images/20251113210024.png)
...
![](https://cdn.jsdelivr.net/gh/Leslie-Lu/images/images/20251113212344.png)

目前中山大学开源软件镜像站已支持Ubuntu、Debian、Fedora等主流开源系统的软件镜像源，同时也支持OpenCloudOS、OpenEuler、Anthon等国产开源软件，并且是华南地区首个支持国产操作系统Anthon软件镜像源的镜像站。

11. [工程学和计算机科学领域前沿图书](https://mp.weixin.qq.com/s/-LcLqEhd3imBDmbC8E_KZg)
